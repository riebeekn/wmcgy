defmodule WmcgyWeb.CoreComponents do
  @moduledoc """
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-zinc-600">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-zinc-300 text-emerald-600 focus:ring-emerald-700"
          {@rest}
        />
        <%= @label %>
      </label>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WmcgyWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WmcgyWeb.Gettext, "errors", msg, opts)
    end
  end
